                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    options={models.map(m => ({
                      value: m.model_id,
                      label: m.model_name,
                      description: `${m.model_id}${m.description ? ' - ' + m.description : ''} (${m.model_provider})`,
                  ...
                  <Select
                    ...
                    options={[
                      ...
                      ...models.map(m => ({
                        value: m.model_id,
                        label: m.model_name,
                        description: `${m.model_id}${m.description ? ' - ' + m.description : ''} (${m.model_provider})${m.is_small_fast ? t('agent.configDialog.modelSelect.smallFast.options.tagFast') : ''}`,
                        isDefault: m.is_default,
                        isSmallFast: m.is_small_fast,
                        isVisual: m.is_visual
                      }))
                  ...
                  <Select
                    ...
                    options={[
                      ...
                      ...models.map(m => ({
                        value: m.model_id,
                        label: m.model_name,
                        description: `${m.model_id}${m.description ? ' - ' + m.description : ''} (${m.model_provider})${m.is_visual ? t('agent.configDialog.modelSelect.visual.options.tagVisual') : ''}`,
                        isDefault: m.is_default,
                        isSmallFast: m.is_small_fast,
                        isVisual: m.is_visual
                      }))
                  ...
                  <Select
                    ...
                    options={[
                      ...
                      ...models.map(m => ({
                        value: m.model_id,
                        label: m.model_name,
                        description: `${m.model_id}${m.description ? ' - ' + m.description : ''} (${m.model_provider})${m.is_compact ? t('agent.configDialog.modelSelect.compact.options.tagCompact') : ''}`,
                        isDefault: m.is_default,
                        isSmallFast: m.is_small_fast,
                        isVisual: m.is_visual,
