...
Build when you need.`,
  ...
  tools: {
    ...
    credentials: {
      personalTitle: "个人凭据",
      personalDescription: "这些凭据仅用于你自己的工具运行。",
      instanceTitle: "实例默认凭据",
      instanceDescription: "当用户未配置个人凭据时使用这些默认凭据。",
      instanceUnavailable: "当前部署不支持配置实例级凭据。",
      configured: "已配置",
      configOnly: "仅配置",
      notConfigured: "未配置",
      configure: "配置凭据",
      ...
      deleteSuccess: "凭据已删除",
      deleteFailed: "删除凭据失败",
      deleteConfirm: "确认删除凭据字段 {field} 吗？",
      deleteAll: "全部删除",
      deleteAllSuccess: "工具凭据已删除",
      deleteAllFailed: "删除工具凭据失败",
      deleteAllConfirm: "确认删除当前范围内 {tool} 的全部已保存凭据吗？",
      currentSource: "当前来源",
      validation: {
      ...
      toolNames: {
        web_search: "Google 网络搜索",
        tavily_web_search: "Tavily 网络搜索",
        exa_web_search: "Exa 网络搜索",
        zhipu_web_search: "智谱网络搜索",
        sql_query: "SQL 查询",
      },
      status: {
        user: "个人凭据",
