...
Build when you need.`,
  ...
  tools: {
    ...
    credentials: {
      personalTitle: "Personal Credentials",
      personalDescription: "Use these credentials for your own tool runs.",
      instanceTitle: "Instance Defaults",
      instanceDescription: "Use these defaults when a user has not configured personal credentials.",
      instanceUnavailable: "Instance credential configuration is not available in this deployment.",
      ...
      deleteConfirm: "Delete credential field {field}?",
      deleteAll: "Delete all",
      deleteAllSuccess: "Tool credentials deleted",
      deleteAllFailed: "Failed to delete tool credentials",
      deleteAllConfirm: "Delete all stored credentials for {tool} in this scope?",
